...
public class FileUtils {
     ...
     public static boolean createFileorFolder(File file) {
         ...
         if (file != null) {
             ...
             try {
                 ...
                 success = false;
                 Log.d(TAG, "createFile() failed !cause:" + e.getMessage());
                 e.printStackTrace();
             }
         }
         return success;
    ...
    public static File getNewestFile(List<File> files) {
		...
		for(File file : files){
			Log.d(TAG,"onStart() ---->"+file.getName()+"  lastModified = "+file.lastModified());
    ...
    public static String getFileMD5(String file) {
        ...
        try {
            ...
            Log.d(TAG, "getFileMD5:GenMd5 success! spend the time: "
    ...
    public static void combineFiles(List<File> files,String saveFileName) throws IOException{
    	if(files==null||files.isEmpty()){
    		Log.d(TAG, "no file need to be combined, return and do nothing");
    		return;
    	}
    ...
    public static AppSnippet getAppSnippet(Context context, String archiveFilePath){
        ...
        if (info != null) {
            ...
            size = new File(archiveFilePath).length();
        }
      ...
      AppSnippet snippet = new AppSnippet(icon, label, packageName);
      snippet.setFileName(archiveFilePath);
      snippet.setFileSize(size);
      boolean isInstalled = APKUtil.isAppInstalled(context, packageName);
      snippet.setInstalled(isInstalled);
       return snippet;
    }
